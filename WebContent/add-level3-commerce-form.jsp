...
<div id="page">
    ...
    <div id="content" style=" color: white; background-color: #041633">
        <div style="background-color: #041633">
            ...
            <p><p>Grade 12 and Grade 13 are included in the Level 3</p>
            <p>There are Three Streams,BioScience,Physical Science and Commerce</p></p>
            
            <div class="section" style="background-color: #041633">
                <div id="aside1" style="background-color: orange">
                    <h5>This is the subject Selection page of Commerce Stream</h5>
